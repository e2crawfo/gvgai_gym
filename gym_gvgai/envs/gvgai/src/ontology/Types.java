...
/**
 * Created with IntelliJ IDEA. User: Diego Date: 17/10/13 Time: 11:05 This is a
...
public class Types {
	...
	public static final int NUM_LEARNING_LEVELS = 6;
	public static final int NUM_TRAINING_LEVELS = 6; // NUM_EVALUATION = NUM_LEARNING_LEVELS - NUM_TRAINING_LEVELS
	...
	public static int[][] ALL_ACTIONS = new int[][] {
			{ KeyEvent.VK_UP, KeyEvent.VK_LEFT, KeyEvent.VK_DOWN, KeyEvent.VK_RIGHT, KeyEvent.VK_SPACE,
					KeyEvent.VK_ESCAPE },
			{ KeyEvent.VK_W, KeyEvent.VK_A, KeyEvent.VK_S, KeyEvent.VK_D, KeyEvent.VK_SHIFT, KeyEvent.VK_ESCAPE } };

	public static enum ACTIONS {
		ACTION_NIL(new int[] { 0, 0 }), ACTION_UP(new int[] { KeyEvent.VK_UP, KeyEvent.VK_W }),
		...
		public static boolean isMoving(ACTIONS value) {
			return value == ACTIONS.ACTION_UP || value == ACTIONS.ACTION_DOWN || value == ACTIONS.ACTION_LEFT
					|| value == ACTIONS.ACTION_RIGHT;
		}
