...
public class TransformTo extends Effect {
	...
	public void execute(VGDLSprite sprite1, VGDLSprite sprite2, Game game) {
		if (sprite1 == null) {
			Logger.getInstance()
					.addMessage(new Message(Message.WARNING, "1st sprite can't be EOS with TransformTo interaction."));
			return;
		}
	...
	protected void transformTo(VGDLSprite newSprite, VGDLSprite sprite1, VGDLSprite sprite2, Game game) {
		...
		if (newSprite != null) {
			...
			newSprite.lastrect = new Rectangle(sprite1.lastrect.x, sprite1.lastrect.y, sprite1.lastrect.width,
