...
/**
 * Created with IntelliJ IDEA. User: Diego Date: 04/11/13 Time: 13:25 This is a
    ...
    public void execute(VGDLSprite sprite1, VGDLSprite sprite2, Game game) {
        if (sprite1 == null || sprite2 == null) {
            Logger.getInstance().addMessage(new Message(Message.WARNING,
                    "Neither the 1st nor 2nd sprite can be EOS with CollectResourceIfHeld interaction."));
            return;
        }
