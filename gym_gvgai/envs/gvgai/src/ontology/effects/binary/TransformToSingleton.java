...
public class TransformToSingleton extends Effect {
    ...
    // true if orientation of sprite 2 should be inherited. Otherwise, orientation
    // is kept.
    ...
    public void execute(VGDLSprite sprite1, VGDLSprite sprite2, Game game) {
        if (sprite1 == null || sprite2 == null) {
            Logger.getInstance().addMessage(new Message(Message.WARNING,
                    "Neither the 1st nor 2nd sprite can be EOS with TransformToSingleton interaction."));
            return;
        }
