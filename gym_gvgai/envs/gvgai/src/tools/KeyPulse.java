...
/**
 * This class is used to manage the key input. Created by Diego Perez,
 * University of Essex. Date: 20/12/11
 */
@SuppressWarnings("unchecked")
public class KeyPulse extends KeyHandler {

    // Pulses holds the key presses, although they are not mapped to actions until
    // they are released.
    private boolean[] pulses = new boolean[1000];

    // Queue with pulses, to be mapped into actions as they were created (on key
    // releases).
    ...
    // Sets the mask for this cycle. In this KeyHandler, only one action per frame
    // is guaranteed:
    @Override
