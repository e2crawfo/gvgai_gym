...
public class LevelAnalyzer {
            ...
            for (int x = 0; x < level[y].length; x++) {
                ...
                if (parts != null) {
                    for (String part : parts) {
                        ...
                        if (!borderSprites.contains(s)
                                && (x == 0 || y == 0 || x == getWidth() - 1 || y == getLength() - 1)) {
                            borderSprites.add(s);
                        }
                    ...
                    for (String part : parts) {
                        ...
                        if (s1 != null) {
                            for (String part2 : parts) {
                                SpriteData s2 = getSpriteData(gameSprites, part2.trim());
     ...
     * @return the current spritedata corresponding to the spritename or null if
     *         doesn't exist
     */
    ...
    /**
     * Get an array of sprites that their percentage is between lowThreshold and
     * highThreshold
     *
     * @param list          the list required to be searched
     * @param lowThreshold  the minimum percentage that the searched sprite cover
     *                      the map
     * @param highThreshold the maximum percentage that the searched sprite cover
     *                      the map
     * @param inMap         boolean to define if the sprite has to be in the defined
     *                      level
    ...
    public SpriteData[] getAvatars(boolean inMap) {
        ...
        return inMap ? getSpriteData(avatarSprites, 1, this.getArea())
                : getSpriteData(avatarSprites, 0, this.getArea());
    }
    ...
    /**
     * get all immovables that are in between lowThreshold and highThreshold
     * percentages
     *
     * @param lowThreshold  the lowest percentage
     * @param highThreshold the maximum percentage
    ...
    public SpriteData[] getImmovables(double lowThreshold, double highThreshold) {
        return getSpriteData(immovableSprites, (int) (lowThreshold * this.getArea()),
                (int) (highThreshold * this.getArea()));
    }
    ...
    public SpriteData[] getImmovables(boolean inMap) {
        return inMap ? getSpriteData(immovableSprites, 1, this.getArea())
                : getSpriteData(immovableSprites, 0, this.getArea());
    }

    /**
     * get all movables that are in between lowThreshold and highThreshold
     * percentages
     *
     * @param lowThreshold  the lowest percentage
     * @param highThreshold the maximum percentage
    ...
    public SpriteData[] getMovables(double lowThreshold, double highThreshold) {
        return getSpriteData(movableSprites, (int) (lowThreshold * this.getArea()),
                (int) (highThreshold * this.getArea()));
    }
    ...
    public SpriteData[] getMovables(boolean inMap) {
        return inMap ? getSpriteData(movableSprites, 1, this.getArea())
                : getSpriteData(movableSprites, 0, this.getArea());
    }

    /**
     * get all portals that are in between lowThreshold and highThreshold
     * percentages
     *
     * @param lowThreshold  the lowest percentage
     * @param highThreshold the maximum percentage
    ...
    public SpriteData[] getPortals(double lowThreshold, double highThreshold) {
        return getSpriteData(portalsSprites, (int) (lowThreshold * this.getArea()),
                (int) (highThreshold * this.getArea()));
    }
    ...
    public SpriteData[] getPortals(boolean inMap) {
        return inMap ? getSpriteData(portalsSprites, 1, this.getArea())
                : getSpriteData(portalsSprites, 0, this.getArea());
    }

    /**
     * get all resources that are in between lowThreshold and highThreshold
     * percentages
     *
     * @param lowThreshold  the lowest percentage
     * @param highThreshold the maximum percentage
    ...
    public SpriteData[] getResources(double lowThreshold, double highThreshold) {
        return getSpriteData(resourceSprites, (int) (lowThreshold * this.getArea()),
                (int) (highThreshold * this.getArea()));
    }
    ...
    public SpriteData[] getResources(boolean inMap) {
        return inMap ? getSpriteData(resourceSprites, 1, this.getArea())
                : getSpriteData(resourceSprites, 0, this.getArea());
    }

    /**
     * get all spawners that are in between lowThreshold and highThreshold
     * percentages
     *
     * @param lowThreshold  the lowest percentage
     * @param highThreshold the maximum percentage
    ...
    public SpriteData[] getSpawners(double lowThreshold, double highThreshold) {
        return getSpriteData(spawnerSprites, (int) (lowThreshold * this.getArea()),
                (int) (highThreshold * this.getArea()));
    }
    ...
    public SpriteData[] getSpawners(boolean inMap) {
        return inMap ? getSpriteData(spawnerSprites, 1, this.getArea())
                : getSpriteData(spawnerSprites, 0, this.getArea());
    }

    /**
     * get all border objects that are in between lowThreshold and highThreshold
     * percentages
     *
     * @param lowThreshold  the lowest percentage
     * @param highThreshold the maximum percentage
    ...
    public SpriteData[] getBorderObjects(double lowThreshold, double highThreshold) {
        return getSpriteData(borderSprites, (int) (lowThreshold * this.getArea()),
                (int) (highThreshold * this.getArea()));
    }
     ...
     *
     * @param spriteName the name of the sprite
     * @return list of all sprites that share the same tile with the specified
     *         spritename
     */
