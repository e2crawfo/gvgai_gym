...
/**
 * This class represents a vector, or a position, in the map. PTSP-Competition
 * Created by Diego Perez, University of Essex. Date: 19/12/11
 */
...
//        h = 2 * h;
	 ...
	 * @return the distance, in pixels, between this vector and the pair of
	 *         coordinates.
	 */
	...
	/**
	 * Calculates the dot product between this vector and the one passed by
	 * parameter.
	 * 
