...
public class LevelGenerator extends AbstractLevelGenerator {
    ...
    /**
     * Constructor for the RandomLevelGenerator where it initialize the random
     * object used.
     * 
     * @param game         Abstract game description object. This object contains
     *                     all needed information about the current game.
     * @param elapsedTimer Timer to define the maximum amount of time for the
     *                     constructor.
     */
    ...
    /**
     * Add random unique x and y value that is not found in the list of points
     * associated with a certain character c
     * 
    ...
    /**
     * Generate a level string randomly contains only one avatar, 80% free space,
     * and 20% of random sprites
     * 
     * @param game         Abstract game description object. This object contains
     *                     all needed information about the current game.
     * @param elapsedTimer Timer to define the maximum amount of time for the level
     *                     generation.
     */
    @Override
    public String generateLevel(GameDescription game, ElapsedCpuTimer elapsedTimer) {
        ...
        // Get a random width and random height value based on the length of game
        // sprites
