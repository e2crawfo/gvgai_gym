...
public class DesignMachine {
     ...
     */
    public double[] runOneGame(int[] parameters, String game_file, String level_file, boolean visuals,
    ...
    public int getDimSize(int dim_idx) {
        return numValuesGenome[dim_idx];
    }

    /** DEBUG FUNCTIONS **/

    public void printValues(int[] parameters) {
        // First, we don't know if this game has been played before, so we'll reset just
        // in case.
        toPlay.reset();
