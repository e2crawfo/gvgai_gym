...
public class ArcadeMachine {
     ...
     * @param agentNames names (inc. package) where the tracks are otherwise. Names
     *                   separated by space.
     * @param actionFile filename of the files where the actions of these players,
     ...
     * @param level_file file with the level to be played.
     * @param visuals    true to show the graphics, false otherwise.
     * @param actionFile name of the file where the actions of these players, for
     *                   this game, must be read from. If the game is multi player,
     *                   this file contains meta game information (winner, scores,
     *                   timesteps, random seed) and names of all the files for
     *                   player actions.
     *
     */
     ...
     * account the initialization time, calling the appropriate constructor with the
     * state observation and time due parameters.
     *
    ...
    /**
     * This methods takes the game and warms it up. This allows Java to finish the
     * runtime compilation process and optimize the code before the proper game
     * starts.
     *
     * @param toPlay  game to be warmed up.
     * @param howLong for how long the warming up process must last (in
     *                milliseconds).
     */
     ...
     * @param record     boolean, true if actions should be recorded, false
     *                   otherwise
