...
public class LearningPlayer extends Player {
	...
	/**
	 * Learning Player constructor. Creates a new server side communication channel
	 * for every player.
	 */
	 ...
	 * accessible from stateObs.getAvailableActions(), or action NIL will be
	 * applied.
	 *
...
//                    System.out.println(sso.toString());
			...
			// System.out.println("Received ACTION: " + response + "; ACT (Server) Response
			// time: "
	...
	/***
	 * @param so           State observation of the current game in its initial
	 *                     state
...
//        System.out.println("Client replied: " + result);
	 ...
	 *
	 * @return true or false, depending on whether the initialization has been
	 *         successful
	 */
