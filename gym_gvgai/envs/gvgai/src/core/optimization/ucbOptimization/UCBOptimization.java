...
public class UCBOptimization implements OptimizationObjective {
     ...
     * @param evaluation the maximum number of calls allowed for the evaluation
     *                   function
     ...
     * @return array of fitness against all objectives (the higher the better), null
     *         if you exceed the number of allowed evaluations
     */
    @Override
