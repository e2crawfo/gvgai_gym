...
/**
 * Created by Diego on 18/03/14. This class encapsulates a SpriteGroup: a
 * collection of VGDLSprite objects identified with an unique id. All sprites in
 * the SpriteGroup are of the same type.
 */
public class SpriteGroup {
	...
	/**
	 * Collection of sprites. They are maintained in a ConcurrentHashMap, where the
	 * key is the unique identifier for the given sprite (in the whole game).
	 */
	...
	/**
	 * Gets the set of KEYs in an array. It will return null if the collection of
	 * sprites is empty.
	 * 
...
//    }
	...
	/**
	 * Gets an ordered iterator through all sprites. It will return null if the
	 * collection of sprites is empty.
	 * 
	...
	/**
	 * Retrieves a sprite given its unique ID. It'll return null if the sprite is
	...
	/**
	 * Retrieves a sprite given its position in the sprite list. Returns null sprite
