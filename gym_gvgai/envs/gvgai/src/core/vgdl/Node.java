...
public class Node {
	 ...
	 * @param indent      indent level of this node, to determine its place on the
	 *                    tree.
	...
	/**
	 * Inserts a new node in the tree structure. Navigates from this node up towards
	 * the root, inserting the new node at the correct indent.
	 * 
