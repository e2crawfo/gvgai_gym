...
/**
 * Created with IntelliJ IDEA. User: Diego Date: 27/10/13 Time: 12:22 This is a
...
public class VGDLRegistry {
	...
	/**
	 * Maps strings to int. Strings are VGDL identifiers for SPRITE TYPES, while
	 * integers are their unique int identifier counterparts.
	 */
	...
	/**
	 * Returns the String associated with the first (and in theory, unique) sprite
	 * value passed. This method is for <b>debug purposes only</b>, should not be
	 * used for game execution.
	 * 
	...
	public String getRegisteredSpriteKey(int value) {
		...
		// System.out.println("This method is deprecated, should not be used (other than
		// debug).");
