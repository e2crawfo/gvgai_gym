...
/**
 * Created with IntelliJ IDEA. User: Diego Date: 16/10/13 Time: 14:08 This is a
...
public abstract class Content {
	...
	/**
	 * Main definition of the content. It is always the first word of each line in
	 * VGDL
	 */
	public String identifier;

	/**
	 * List of parameters of this content (key => value). List of all pairs of the
	 * form key=value on the line.
	 */
	public HashMap<String, String> parameters;

	/**
	 * Indicates if this content is definition (i.e., includes character ">" in
	 * VGDL).
	 */
	 ...
	 * 
	 * @param pcs ParameterContent hashmap that defines values for variables
	 *            specified in a GameSpace.
	 */
