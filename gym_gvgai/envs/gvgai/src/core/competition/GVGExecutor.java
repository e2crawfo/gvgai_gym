...
public class GVGExecutor {
	...
	public static void printHelp() {
		...
		// Other examples:
		// -g examples/gridphysics/aliens.txt -l examples/gridphysics/aliens_lvl0.txt
		// -ag tracks.singlePlayer.deprecated.sampleMCTS.Agent -res output_game1.txt
		// -sds 1342 -vis 1 -rep 1
		// -g examples/gridphysics/aliens.txt -l
		// examples/gridphysics/aliens_lvl0.txt:examples/gridphysics/aliens_lvl1.txt -ag
		// tracks.singlePlayer.deprecated.sampleMCTS.Agent -res output_game1.txt -sds
		// 1342 -vis 1 -rep 2
		// -g examples/gridphysics/aliens.txt -l examples/gridphysics/aliens_lvl0.txt
		// -ag tracks.singlePlayer.deprecated.sampleMCTS.Agent -res output_game1.txt
		// -vis 0 -rep 1
		// -g examples/gridphysics/aliens.txt:examples/gridphysics/camelRace.txt -l
		// examples/gridphysics/aliens_lvl0.txt:examples/gridphysics/aliens_lvl1.txt;examples/gridphysics/camelRace_lvl0.txt
		// -ag tracks.singlePlayer.deprecated.sampleMCTS.Agent -res o1.txt:o2.txt -sds
		// 1342:111 -vis 1 -rep 2
		// -g examples/gridphysics/aliens.txt:examples/gridphysics/camelRace.txt -l
		// examples/gridphysics/aliens_lvl0.txt:examples/gridphysics/aliens_lvl1.txt;examples/gridphysics/camelRace_lvl0.txt
		// -ag tracks.singlePlayer.deprecated.sampleMCTS.Agent -res o1.txt:o2.txt -vis 0
		// -rep 2
	}
	...
	public static void main(String args[]) {
		...
		if (resultFiles != null && num_games != resultFiles.length) {
			throw new RuntimeException(
					"If result output files are provided, their number must match the number of games.");
		}
