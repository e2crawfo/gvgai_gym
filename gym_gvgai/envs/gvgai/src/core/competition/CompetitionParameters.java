...
public class CompetitionParameters {
	...
	/**
	 * Milliseconds for controller disqualification, if it returns an action after
	 * this time.
	 */
	...
	/**
	 * Milliseconds allowed for the level generator disqualification, if it returns
	 * a level after this time.
	 */
	...
	/**
	 * Milliseconds allowed for the rule generator disqualification, if it returns
	 * rules after this time.
	 */
	...
	/**
	 * Use sockets for Learning track connection? (NOTE: Client code should also be
	 * configured to use sockets - or not).
	 */
	...
	/**
	 * Indicates if the overspend should be taken into account or not. Time limits
	 * are WALL TIME on Windows, because CPU TIME is not accurate enough at the
	 * level of milliseconds on this OS.
	 */
	...
	/**
	 * Key input type. We set the default here, but this will be set by the game in
	 * VGDL.
	 */
