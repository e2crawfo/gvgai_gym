...
public class Message {
    ...
    /**
     * Base constructor for a Message. Needs a type (0 or 1) and a content message
     *
     * @param type    the type of Message this is, either warning or error
     * @param content the String contained within a Message. This is printed out
