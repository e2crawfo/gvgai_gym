...
public class GameDescription {
	...
	/**
	 * object from the current loaded game. This object is used to initialize other
	 * fields and get interaction data.
	 */
	 ...
	 * Level Mapping.
	 *
	 * @param level a string of characters that are supplied in the character
	 *              mapping
	 * @return StateObservation object that can be used to simulate the game. return
	 *         null when there is errors
	 */
	...
	/**
	 * Build the generated level to be tested using an agent. You should call this
	 * version if you are using your own character mapping
	 *
	 * @param level a string of characters that are supplied in the character
	 *              mapping
	 * @return StateObservation object that can be used to simulate the game. return
	 ...
	 *
	 * @param includeNIL boolean to identify if the NIL action should exists in the
	 *                   supported actions
	 ...
	 * @return an array of all possible effects. If there is no effects, an empty
	 *         array is returned
	 */
