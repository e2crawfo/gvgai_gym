...
public class SerializableStateObservation {
    ...
    private void buildDataArraylists(StateObservation s) {
        ...
        /*
         * The following block is a sequence of iterative attributions that render the
         * game-information holding array objects to be sent and interpreted by the
         * agent.
         */
    ...
    public String toString() {
        ...
        return "SerializableStateObservation{" + "imageArray=" + Arrays.toString(imageArray) + ", isValidation="
                + isValidation + ", gameScore=" + gameScore + ", gameTick=" + gameTick + ", gameWinner=" + gameWinner
                + ", isGameOver=" + isGameOver + ", worldDimension=" + Arrays.toString(worldDimension) + ", blockSize="
                + blockSize + ", noOfPlayers=" + noOfPlayers + ", avatarSpeed=" + avatarSpeed + ", avatarOrientation="
                + Arrays.toString(avatarOrientation) + ", avatarPosition=" + Arrays.toString(avatarPosition)
                + ", avatarLastAction=" + avatarLastAction + ", avatarType=" + avatarType + ", avatarHealthPoints="
                + avatarHealthPoints + ", avatarMaxHealthPoints=" + avatarMaxHealthPoints + ", avatarLimitHealthPoints="
                + avatarLimitHealthPoints + ", isAvatarAlive=" + isAvatarAlive + ", phase=" + phase
                + ", availableActions=" + availableActions + ", avatarResources=" + avatarResources
                + ", observationGrid=" + Arrays.toString(observationGrid) + ", NPCPositions="
                + Arrays.toString(NPCPositions) + ", immovablePositions=" + Arrays.toString(immovablePositions)
                + ", movablePositions=" + Arrays.toString(movablePositions) + ", resourcesPositions="
                + Arrays.toString(resourcesPositions) + ", portalsPositions=" + Arrays.toString(portalsPositions)
