...
public class Observation implements Comparable<Observation> {
    ...
    /**
     * Reference to the position used for comparing this observation with others.
     */
     ...
     * @param category     category of this observation (NPC, static, resource,
     *                     etc.)
     */
    ...
    /**
     * Compares two Observations to check if they are equal. The reference attribute
     * is NOT compared in this object.
     *
    ...
    public String toString() {
        return "Observation{" + "category=" + category + ", itype=" + itype + ", obsID=" + obsID + ", position="
                + position + ", reference=" + reference + ", sqDist=" + sqDist + "}\n";
    }
}